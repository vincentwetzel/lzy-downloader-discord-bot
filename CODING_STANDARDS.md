...
* **Keep Documentation in Sync**: Code changes that alter system behavior, API endpoints, or active actors must be accompanied by corresponding updates to `README.md`, `ARCHITECTURE.md`, and `AGENTS.md`.
