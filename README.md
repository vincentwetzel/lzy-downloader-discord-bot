...
- **Sleep/Wake Recovery:** The bridge watches prolonged Discord Gateway loss and exits after a bounded recovery period so the Windows supervisor can restart it; the launcher also prevents duplicate supervisor loops. The stop script disables this restart loop before shutting it down.
